...
class ViewStateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var messageStyle = titleStyle.copyWith(
        color: titleStyle.color.withOpacity(0.7), fontSize: sp(15));
    return Container(
      color: Theme.of(context).primaryColor,
      child: Column(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  child: image ??
                      Image.asset('images/mian/empty.png', fit: BoxFit.fill),
                ),
                ConstrainedBox(
                  constraints: BoxConstraints(
                      maxHeight: height(100), minHeight: height(50)),
  ...
  Widget build(BuildContext context) {
    ...
    switch (error.errorType) {
      case ViewStateErrorType.networkTimeOutError:
        ...
        // );
        defaultImage = Image.asset('images/home/empty.png',
            width: width(361), height: width(362));
