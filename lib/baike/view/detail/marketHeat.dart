    ...
    return  Consumer<baikeProvider>(
     ...
     /*     AnimatedBuilder(
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: Utils.normalText(
                          '${model.projectDetail.levels.descript.grade[2].level ?? ""}',
                          color: Color(0xffFFFFFF),
                          fontSize: 36,
                          fontWeight: FontWeight.bold),
                    ),
          ...
          Container(
            ...
            height: height(50 *
                double.parse(model
                    .projectDetail.levels.descript.grade[2].subordinate.length
                    .toString())),
            child: MediaQuery.removePadding(
                removeTop: true,
                context: context,
                child: model.projectDetail.levels.descript.grade[2].subordinate
                            .length >
                        0
                    ? ListView.builder(
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: model.projectDetail.levels.descript.grade[2]
                            .subordinate.length,
                            ...
                            child: Row(
                              children: [
                                ...
                                /*    Container(
                                    width: width(150),
                                    child: Utils.normalText(
                                      '${model.projectDetail.levels.descript.grade[2].subordinate[index].name}',
                                    )),*/
                                Container(
                                  width: width(150),
                                  child: Text(
                                                            ...
                                                            children: [
                                                              Container(
                                                                width:
                                                                    width(160),
                                                                child: Text(
                                                                    '${model.projectDetail.levels.descript.grade[2].subordinate[index].grade[index2].name ?? ""}',
                                                                    maxLines: 1,
                                                                    style: TextStyle(
                                                                        fontSize: sp(
                                                                            28)),
                                                              ...
                                                              Container(
                                                                width:
                                                                    width(180),
                                                                child: Text(
                                                                    '${model.projectDetail.levels.descript.grade[2].subordinate[index].grade[index2].content ?? ""}',
                                                                    maxLines: 1,
                                                                    style: TextStyle(
                                                                        fontSize: sp(
                                                                            28)),
                                                              ...
                                                              Expanded(
                                                                  child: Utils.normalText(
                                                                      '${model.projectDetail.levels.descript.grade[2].subordinate[index].grade[index2].totalScore ?? ""}',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .center)),
                                                              Expanded(
                                                                  child: Utils.normalText(
                                                                      '${model.projectDetail.levels.descript.grade[2].subordinate[index].grade[index2].score ?? ""}',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .center)),
                                                            ],
