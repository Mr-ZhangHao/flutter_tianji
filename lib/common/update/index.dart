...
import 'package:flutter_tianji/common/update/update_dialog.dart';
import 'package:flutter_tianji/core/model/update_app.dart';
import 'package:flutter_tianji/core/network/api.dart';
      ...
      if (localVersion < int.parse(version.versionCode)) {
        ...
        showBottomInCenterDialog(
            ...
            UpDateVersionDialog(
              ...
              androidUrl: version.apkUrl, //android
              iosUrl: version.downloadUrl, //  ios
            ));
      } else {
...
class _UpdateState extends State<Update> {
  ...
  Future<File> downloadAndroid(String url) async {
    ...
    File file = new File(
        '$storagePath/${GlobalConfig.aesKey}v${GlobalConfig.andVersionName}.apk');
