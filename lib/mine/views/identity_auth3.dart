            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: height(20)),
                  Text('*${Tr.of(context).uploadPassport7}',
    ...
    if (_backLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            ...
            buttontext: '${Tr.of(context).uploadPassport2}'),
      );
      ...
      return InkWell(
          ...
          child: CardImageLoadErrorWidget(
              imageUrl: '', buttontext: '${Tr.of(context).reUpload}'));
    }
  }
  ...
  Widget _cardFrontImage() {
    if (_frontLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            imageUrl: 'images/c2c/c2c_upload.png',
            buttontext: '${Tr.of(context).uploadPassport}'),
      );
  ...
  Widget _cardhandleImage() {
    if (_shouLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            imageUrl: 'images/c2c/c2c_upload.png',
            buttontext: '${Tr.of(context).uploadPassport3}'),
      );
