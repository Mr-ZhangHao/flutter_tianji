          ...
          children: <Widget>[
            ListTile(
              ...
              contentPadding: EdgeInsets.symmetric(
                  vertical: height(10), horizontal: width(40)),
              leading: Image.asset('images/mine/tg.png',
                  width: width(68), height: height(68)),
              title: Text('Telegram',
                  style: TextStyle(color: Color(0xff323232), fontSize: sp(32))),
            ),
            CustomDivider(),
            ListTile(
                dense: true,
                contentPadding: EdgeInsets.symmetric(
                    vertical: height(0), horizontal: width(40)),
                leading: Image.asset('images/mine/wx.png',
                    width: width(68), height: height(68)),
                title: Text(Tr.of(context).WeChat,
                    style:
                        TextStyle(color: Color(0xff323232), fontSize: sp(32))),
                subtitle: Row(
                  children: <Widget>[
                ...
                trailing: InkWell(
                  ...
                  child: Image.asset('images/mine/qrcode@3x.png',
                      width: width(44)),
                )),
            CustomDivider(),
            ListTile(
              ...
              contentPadding: EdgeInsets.symmetric(
                  vertical: height(10), horizontal: width(40)),
              leading: Image.asset('images/mine/xl.png',
                  width: width(68), height: height(68)),
              title: Text(Tr.of(context).Weibo,
                  style: TextStyle(color: Color(0xff323232), fontSize: sp(32))),
            ),
            ...
            ListTile(
              ...
              contentPadding: EdgeInsets.symmetric(
                  vertical: height(10), horizontal: width(40)),
              leading: Image.asset('images/mine/kf.png',
                  width: width(68), height: height(68)),
              title: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text(Tr.of(context).customerService,
                      style: TextStyle(
                          color: Color(0xff323232), fontSize: sp(32))),
                  Row(
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          Clipboard.setData(
                              ClipboardData(text: 'Support@etfget.com'));
                          Toast.showText(Tr.of(context).copySuccessfully);
                        },
                        child: Image.asset(
                          'images/mine/copy2.png',
            ...
            ListTile(
              ...
              contentPadding: EdgeInsets.symmetric(
                  vertical: height(10), horizontal: width(40)),
              leading: Image.asset('images/mine/hz.png',
                  width: width(68), height: height(68)),
              title: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text(Tr.of(context).marketCollaboration,
                      style: TextStyle(
                          color: Color(0xff323232), fontSize: sp(32))),
                  Row(
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          Clipboard.setData(
                              ClipboardData(text: 'BD@etfget.com'));
                          Toast.showText(Tr.of(context).copySuccessfully);
                        },
                        child: Image.asset(
                          'images/mine/copy2.png',
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text('${Tr.of(context).CommunityHint}',
                style: TextStyle(
                    color: Colors.black,
                    fontSize: sp(32),
            ...
            SizedBox(height: width(40)),
            Text('${Tr.of(context).SaveHint}',
                style: TextStyle(color: Color(0xff838383), fontSize: sp(30))),
          ],
        ),
      ),
    );
