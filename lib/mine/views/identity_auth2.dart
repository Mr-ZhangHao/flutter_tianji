          ...
          Consumer<MineProvider>(
            ...
            child: Container(
              ...
              child: Text(Tr.of(context).submit,
                  style: TextStyle(color: kPrimaryColor, fontSize: sp(30))),
            ),
          ),
        ],
      ),
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: EdgeInsets.symmetric(vertical: height(20)),
                child: Text(Tr.of(context).UploadRequest,
                    style: TextStyle(
                        fontSize: sp(30), fontWeight: FontWeight.bold)),
              ),
              Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: height(20)),
                  Text(Tr.of(context).UploadHint3,
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: EdgeInsets.symmetric(vertical: height(20)),
                child: Text(Tr.of(context).UploadHint4,
                    style: TextStyle(
                        fontSize: sp(30), fontWeight: FontWeight.bold)),
              ),
              Row(
    ...
    if (_backLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            imageUrl: 'images/c2c/c2c_upload.png',
            buttontext: '${Tr.of(context).IDCardPhoto2}'),
      );
      ...
      return InkWell(
          ...
          child: CardImageLoadSuccessWidget(
              imageUrl: _backImage, buttontext: '${Tr.of(context).reUpload}'));
    } else {
      // error
      return InkWell(
          onTap: () => _chooseCamereOrGallery('back'),
          child: CardImageLoadErrorWidget(
              imageUrl: 'images/c2c/c2c_upload.png',
              buttontext: '${Tr.of(context).reUpload}'));
    }
  }
  ...
  Widget _cardFrontImage() {
    if (_frontLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            imageUrl: 'images/c2c/c2c_upload.png',
            buttontext: '${Tr.of(context).IDCardPhoto}'),
      );
  ...
  Widget _cardhandleImage() {
    if (_shouLoadType == LoadType.waiting) {
      return InkWell(
        ...
        child: CardImageBaseWidget(
            imageUrl: 'images/c2c/c2c_upload.png',
            buttontext: '${Tr.of(context).IDCardPhotoHint2}'),
      );
      ...
      return InkWell(
          onTap: () => _chooseCamereOrGallery('shou'),
          child: CardImageLoadSuccessWidget(
              imageUrl: _shouImage, buttontext: '${Tr.of(context).reUpload}'));
    } else {
      // error
      return InkWell(
          onTap: () => _chooseCamereOrGallery('shou'),
      ...
      child: Column(
        ...
        children: <Widget>[
          GestureDetector(
            ...
            onTap: () => {onTab('1')},
            child: Container(
                child: Text(Tr.of(context).IDCard),
          ...
          GestureDetector(
            ...
            onTap: () => {onTab('2')},
            child: Container(
                child: Text(Tr.of(context).Passport),
                width: double.infinity,
                alignment: Alignment.center),
          ),
        ],
