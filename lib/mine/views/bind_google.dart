...
class _BindGooglePageState extends State<BindGooglePage> {
  ...
  final TextStyle style2 = TextStyle(
      color: Color(0xff323232), fontSize: sp(24), fontWeight: FontWeight.bold);
                    ...
                    return InputWidget(
                      ...
                      suffixIcon: GestureDetector(
                        onTap: () {
                          print('1');
                          Clipboard.setData(
                              ClipboardData(text: model.googleSecret));
                        ...
                        child: Container(
                            ...
                            child: Text(Tr.of(context).copy,
                                style: TextStyle(
                                    color: kPrimaryColor, fontSize: sp(28)))),
                      ),
                    );
                  },
                ),
  ...
  void _confirm() async {
    ...
    if ((tfaType == 1 || tfaType == 3 || tfaType == 5 || tfaType == 6) &&
      ...
      try {
        await MineServer.bindGoogle(
            googleSecret, _ecodeCtr.text, _codeCtr.text, _gcodeCtr.text);
