...
import 'package:flutter_tianji/home/provider/notice_provider.dart';
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      return NoticesItemWidget(
                        index: index,
                        onTab: () {
                          RouterUtil.push(context, HomeRouter.noticeDetail);
                        },
                      );
                    },
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Image.asset('images/login/laba.png',
